## 3.0-55 — Conteúdo aplicado aos curingas
...
## 3.0-55 — Busca por múltiplas palavras-chave
...
## 3.0-55 — Correção da busca por conteúdo
...
## 3.0-55 — Pesquisa restaurada da v18
...
## 3.0-55 — Fluxo de pesquisa baseado na v18
...
## 3.0-55 — Retorno automático para a lista
...
## 3.0-55 — Pesquisa por nomes e curingas
...
## 3.0-55 — Índice do cursor na lista filtrada
...
## 3.0-55 — Restauração correta do cursor com filtro
...
## 3.0-55 — Persistência do filtro ao retornar
...
## 3.0-55 — Pergunta de correção no terminal
...
## 3.0-55 — Correção de referências ausentes
...
## 3.0-55 — Validação de integridade
