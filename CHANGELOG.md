...
## 3.0-48 — Pesquisa por nomes e curingas
...
## 3.0-48 — Índice do cursor na lista filtrada
...
## 3.0-48 — Restauração correta do cursor com filtro
...
## 3.0-48 — Persistência do filtro ao retornar
...
## 3.0-48 — Pergunta de correção no terminal
...
## 3.0-48 — Correção de referências ausentes
...
## 3.0-48 — Validação de integridade
