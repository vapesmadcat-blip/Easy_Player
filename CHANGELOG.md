## 3.0-49 — Retorno automático para a lista
...
## 3.0-49 — Pesquisa por nomes e curingas
...
## 3.0-49 — Índice do cursor na lista filtrada
...
## 3.0-49 — Restauração correta do cursor com filtro
...
## 3.0-49 — Persistência do filtro ao retornar
...
## 3.0-49 — Pergunta de correção no terminal
...
## 3.0-49 — Correção de referências ausentes
...
## 3.0-49 — Validação de integridade
