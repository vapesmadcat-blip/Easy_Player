## 3.0-47 — Pesquisa por nomes e curingas
...
## 3.0-47 — Índice do cursor na lista filtrada
...
## 3.0-47 — Restauração correta do cursor com filtro
...
## 3.0-47 — Persistência do filtro ao retornar
...
## 3.0-47 — Pergunta de correção no terminal
...
## 3.0-47 — Correção de referências ausentes
...
## 3.0-47 — Validação de integridade
