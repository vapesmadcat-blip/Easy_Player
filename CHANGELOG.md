## 3.0-54 — Busca por múltiplas palavras-chave
...
## 3.0-54 — Correção da busca por conteúdo
...
## 3.0-54 — Pesquisa restaurada da v18
...
## 3.0-54 — Fluxo de pesquisa baseado na v18
...
## 3.0-54 — Retorno automático para a lista
...
## 3.0-54 — Pesquisa por nomes e curingas
...
## 3.0-54 — Índice do cursor na lista filtrada
...
## 3.0-54 — Restauração correta do cursor com filtro
...
## 3.0-54 — Persistência do filtro ao retornar
...
## 3.0-54 — Pergunta de correção no terminal
...
## 3.0-54 — Correção de referências ausentes
...
## 3.0-54 — Validação de integridade
