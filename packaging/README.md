...
Depois que a release `eazy-v3.0-5` estiver publicada, em Debian ou Ubuntu execute:
...
O resultado será gerado em `packaging/eazy/dist/eazy_3.0-5_all.deb`. Para inspecionar o pacote sem instalá-lo:

```bash
dpkg-deb --info packaging/eazy/dist/eazy_3.0-5_all.deb
dpkg-deb --contents packaging/eazy/dist/eazy_3.0-5_all.deb
```
