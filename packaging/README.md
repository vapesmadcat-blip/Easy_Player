...
A release atual `eazy-v3.0-60` está publicada. Em Debian ou Ubuntu, execute:
...
O resultado será gerado em `packaging/eazy/dist/eazy_3.0-60_all.deb`. Para inspecionar o pacote sem instalá-lo:

```bash
dpkg-deb --info packaging/eazy/dist/eazy_3.0-60_all.deb
dpkg-deb --contents packaging/eazy/dist/eazy_3.0-60_all.deb
```
