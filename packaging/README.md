...
A release atual `eazy-v3.0-57` está publicada. Em Debian ou Ubuntu, execute:

```bash
curl -fLO https://github.com/vapesmadcat-blip/Easy_Player/releases/download/eazy-v3.0-57/eazy_3.0-57_all.deb
curl -fLO https://github.com/vapesmadcat-blip/Easy_Player/releases/download/eazy-v3.0-57/eazy_3.0-57_all.deb.sha256
sha256sum -c eazy_3.0-57_all.deb.sha256
sudo apt install ./eazy_3.0-57_all.deb
```
...
O resultado será gerado em `packaging/eazy/dist/eazy_3.0-57_all.deb`. Para inspecionar o pacote sem instalá-lo:

```bash
dpkg-deb --info packaging/eazy/dist/eazy_3.0-57_all.deb
dpkg-deb --contents packaging/eazy/dist/eazy_3.0-57_all.deb
```
