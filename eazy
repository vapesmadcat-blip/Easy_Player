...
Depois use:
  ...
  Ctrl-X → limpa só o amarelo" 16 72
    ...
    if [ "$tecla" = "ctrl-n" ]; then
        ...
        # ALT-X: limpa a lista tmp de duplicados (libera Ctrl-D para nova busca)
