...
```bash
rm -f eazy_3.0-58_all.deb eazy_3.0-58_all.deb.sha256
```
...
sha256sum packaging/eazy/dist/eazy_3.0-58_all.deb
sudo apt install ./packaging/eazy/dist/eazy_3.0-58_all.deb
eazy
```
