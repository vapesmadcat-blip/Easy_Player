...
## Debian / Ubuntu — versão 3.0-38

A instalação oficial usa a **Release do GitHub**, o pacote `.deb` e seu checksum SHA-256:

```bash
curl -fLO https://github.com/vapesmadcat-blip/Easy_Player/releases/download/eazy-v3.0-38/eazy_3.0-38_all.deb
curl -fLO https://github.com/vapesmadcat-blip/Easy_Player/releases/download/eazy-v3.0-38/eazy_3.0-38_all.deb.sha256
sha256sum -c eazy_3.0-38_all.deb.sha256
sudo apt install ./eazy_3.0-38_all.deb
eazy
```
...
```bash
rm -f eazy_3.0-38_all.deb eazy_3.0-38_all.deb.sha256
```
...
sha256sum packaging/eazy/dist/eazy_3.0-38_all.deb
sudo apt install ./packaging/eazy/dist/eazy_3.0-38_all.deb
eazy
```
